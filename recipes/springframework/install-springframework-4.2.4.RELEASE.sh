...
export VERSION="4.2.4.RELEASE"

for i in aop aspects beans context context.support core expression jdbc jms messaging orm oxm test transaction web webmvc webmvc.portlet websocket
do
